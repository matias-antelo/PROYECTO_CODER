...
function mostrarTermometrosResiduos(estufasResiduos) {
    confirm("se encontraron 3 Estufas")
    console.log(estufasResiduos);
    console.log("-------------------------");

}
mostrarTermometrosResiduos(estufasResiduos);}
else if(pedirEquipoMostrarQuimica === "micropipeta"){
function mostrarEstufasResiduos(micropipetasResiduos) {
    confirm("se encontraron 3 Micropipetas")
    console.log(micropipetasResiduos);
    console.log("-------------------------");
}
mostrarEstufasResiduos(micropipetasResiduos);
} else if(pedirEquipoMostrarQuimica === "termometros"){
function mostrarMicropipetasResiduos(termometrosResiduos) {
    confirm("se encontraron 3 Termometros")
    console.log(termometrosResiduos);
    console.log("-------------------------");
}
mostrarMicropipetasResiduos(termometrosResiduos);
